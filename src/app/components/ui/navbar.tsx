    ...
    <nav className="sticky top-0 z-40 w-full bg-white px-6 py-4 shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="hidden md:flex space-x-6">
          <Link href="/tentang">
            <span className="text-gray-600 hover:text-blue-600 transition cursor-pointer">Tentang Kami</span>
          </Link>
          <Link href="/faq">
            <span className="text-gray-600 hover:text-blue-600 transition cursor-pointer">FAQ</span>
          </Link>
        </div>
        ...
        <div className="md:hidden flex items-center">
          ...
          >
            <div
              className={`h-1 w-6 bg-gray-600 mb-1 rounded transition-all duration-300 ${isOpen ? "rotate-45 translate-y-2" : ""}`}
            />
            <div
            ...
            <div className="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-xl flex flex-col h-full">
              ...
              <div className="flex flex-col p-4 space-y-6">
                ...
                <Link href="/faq" onClick={closeSidebar}>
                  <span className="block text-gray-600 hover:text-blue-600 transition cursor-pointer py-2">FAQ</span>
                </Link>
