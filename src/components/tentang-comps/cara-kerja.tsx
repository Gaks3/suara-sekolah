    ...
    <div className="max-w-4xl mx-auto mb-16">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Suara Sekolah memiliki alur kerja yang sistematis untuk memastikan
          setiap laporan ditangani dengan baik, dari awal pengaduan hingga
            ...
            <div className="md:w-1/2 md:pr-8 md:text-right order-2 md:order-1">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Warga sekolah dapat menyampaikan laporan melalui berbagai
                  kanal yang tersedia. Setiap laporan akan diberikan nomor tiket
          ...
          <div className="relative flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pl-8 order-2">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Tim kami akan memverifikasi dan mengklasifikasikan laporan
                  berdasarkan jenis, urgensi, dan unit yang bertanggung jawab
                  untuk menanganinya.
                </p>
              </div>
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-8 md:text-right order-2 md:order-1">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Laporan akan diteruskan kepada pihak yang berwenang untuk
                  ditindaklanjuti, baik itu kepala sekolah, guru, atau unit
                  terkait lainnya.
                </p>
              </div>
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pl-8 order-2">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Pihak yang berwenang akan menangani laporan dan memberikan
                  solusi atau tindakan perbaikan yang diperlukan.
                </p>
              </div>
            </div>
            <div className="md:w-1/2 flex justify-center md:justify-end order-1 mb-4 md:mb-0">
          ...
          <div className="relative flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pl-8 order-2">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Kami secara berkala mengevaluasi laporan yang masuk untuk
                  mengidentifikasi pola dan melakukan perbaikan sistemik untuk
